...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
            ...
            if (readPhoneStatePermissionRequestNeeded) {
                ...
                if (formController.getInstanceFile() == null) {
                    ...
                    if (getFormController().getAuditEventLogger().isUserRequired()) {
                        showIdentityPromptDialog(formController, true);
                    } else {
                    ...
                    if (!showFirst) {
                        ...
                        if (getFormController().getAuditEventLogger().isUserRequired()) {
                            showIdentityPromptDialog(formController, false);
                        } else {
    ...
    private void showIdentityPromptDialog(FormController formController, boolean startingNewForm) {
